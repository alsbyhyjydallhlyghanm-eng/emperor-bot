...
def callback_query(call):
    ...
    # --- شحن الحساب ---
        ...
        text = """الإمبراطور 👑 | قمة الفخامة، الأمان، والموثوقية

مرحباً بك في المنصة الرقمية الأقوى على تلجرام. الإمبراطور ليس مجرد بوت، بل هو شريكك الذكي المصمم بأعلى معايير الدقة والسرعة ليلبي كافة احتياجاتك بخدمات استثنائية وأداء لا يضاهى.

ميثاق الثقة والتميز ⚡
• صدق ومصداقية: نلتزم بالشفافية التامة وتقديم خدمات حقيقية ومضمونة 100%.
• أمان مطلق: حماية فائقة لبياناتك وخصوصيتك بأحدث تقنيات التشفير.
• استقرار وقوة: خوادم ذكية تعمل على مدار الساعة دون انقطاع أو تأخير.
• دعم ملكي: خدمة متكاملة وسرعة استجابة فورية تليق بوجودك معنا.

المطور والدعم الفني المباشر 🛡️
الإشراف والتطوير: جيدالله المحولي.
للتواصل والاستفسار المباشر: @geedallh"""
